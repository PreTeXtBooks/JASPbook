...
\begin{figure}[htb]
\begin{center}
\epsfig{file = ../img/fig5-2.png, clip=true,width = 14cm}
...
\begin{figure}[ht]
\begin{center}
\epsfig{file = ../img/fig5-3.png, clip=true,width = 10cm}
...
\begin{figure}[!!htb]
\begin{center}
\epsfig{file = ../img/fig5-4.png, clip=true,width = 14cm}
...
\begin{figure}[!!htb]
\begin{center}
\epsfig{file = ../img/fig5-5.png, clip=true,width = 10cm}
...
\begin{figure}[!!htb]
\begin{center}
\epsfig{file = ../img/fig5-7.png, clip=true,width = 14cm}
